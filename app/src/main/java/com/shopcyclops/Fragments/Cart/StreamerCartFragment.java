...
public class StreamerCartFragment extends android.support.v4.app.Fragment {
    ...
    public void onActivityCreated(Bundle b)
    {
        ...
        checkoutBtn.setOnClickListener(new View.OnClickListener() {
            ...
            if (prefs.getInt(CONSTANTS.STREAM_PROGRESS, 0) == 4) {
            ...
            else if ((prefs.getInt(CONSTANTS.STREAM_PROGRESS, 0) == 2) || (prefs.getInt(CONSTANTS.STREAM_PROGRESS, 0) == 3)) {
                new AlertDialog.Builder(getActivity())
                        .setTitle("Not yet!")
            ...
            else if (prefs.getInt(CONSTANTS.STREAM_PROGRESS, 0) == 3) {
                new AlertDialog.Builder(getActivity())
                        .setTitle("Not yet!")
        ...
        closeStreamBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (prefs.getInt(CONSTANTS.STREAM_PROGRESS, 0) == 2) {
                    new AlertDialog.Builder(getActivity())
