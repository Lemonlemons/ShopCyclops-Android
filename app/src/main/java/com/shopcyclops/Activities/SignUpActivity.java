    ...
    public void SignUp(View v)
    {
        ...
        if (email.equals("")) {
            ...
            try {
                ...
                client.post(this, SECRETS.BASE_URL+"/users", entity, "application/json", new JsonHttpResponseHandler() {
                    @Override
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        try {
                            SharedPreferences prefs = SignUpActivity.this.getSharedPreferences(SECRETS.SHARED_PREFS_KEY, Context.MODE_PRIVATE);
