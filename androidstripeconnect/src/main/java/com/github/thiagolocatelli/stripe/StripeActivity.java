...
public class StripeActivity extends Activity {
	...
	private void getAccessToken(String code) {
		try {
            ...
            boolean livemode = obj.getBoolean("livemode");
            String refresh_token = obj.getString("refresh_token");
            String token_type = obj.getString("token_type");
            stripe_publishable_key = obj.getString("stripe_publishable_key");
            stripe_user_id = obj.getString("stripe_user_id");
            String scope = obj.getString("scope");
			
			AppLog.i(TAG, "getAccessToken", "String data[access_token]:			" + access_token);
			AppLog.i(TAG, "getAccessToken", "String data[livemode]:				" + livemode);
			AppLog.i(TAG, "getAccessToken", "String data[refresh_token]:			" + refresh_token);
			AppLog.i(TAG, "getAccessToken", "String data[token_type]:			" + token_type);
			AppLog.i(TAG, "getAccessToken", "String data[stripe_publishable_key]: " + stripe_publishable_key);
			AppLog.i(TAG, "getAccessToken", "String data[stripe_user_id]:		" + stripe_user_id);
			AppLog.i(TAG, "getAccessToken", "String data[scope]:					" + scope);
    ...
    private void onComplete(Map<String, String> parameters) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                returnIntent.putExtra("STRIPE_PUBLISHABLE_KEY", stripe_publishable_key);
                returnIntent.putExtra("STRIPE_USER_ID", stripe_user_id);
